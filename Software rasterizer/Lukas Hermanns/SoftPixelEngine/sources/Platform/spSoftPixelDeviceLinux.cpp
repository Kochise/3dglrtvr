...
void SoftPixelDeviceLinux::sleep(u32 Milliseconds)
{
...
void SoftPixelDeviceLinux::setWindowTitle(const io::stringc &Title)
{
    Title_ = Title;
    XStoreName(Display_, Window_, Title_.c_str());
}
io::stringc SoftPixelDeviceLinux::getWindowTitle() const
{
    return Title_;
}

void SoftPixelDeviceLinux::setWindowPosition(const dim::point2di &Position)
{
...
dim::point2di SoftPixelDeviceLinux::getWindowPosition() const
{
    return 0; // todo
}

bool SoftPixelDeviceLinux::isWindowActive() const
{
    Window FocusWin;
    s32 State;
