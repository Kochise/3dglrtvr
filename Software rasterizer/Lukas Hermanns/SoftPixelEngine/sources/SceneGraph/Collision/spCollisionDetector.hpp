...
class SP_EXPORT CollisionDetector
{
    ...
    private:
        ...
        SCollisionContact getPolygonCollisionContact(
        ...
        bool checkIntersectionMeshMesh  (Mesh* MeshA, Mesh* MeshB, TreeNodeOct* TreeNodeA);
        bool checkIntersectionMeshMesh  (Mesh* MeshA, Mesh* MeshB, TreeNodeOct* TreeNodeA, TreeNodeOct* TreeNodeB);
