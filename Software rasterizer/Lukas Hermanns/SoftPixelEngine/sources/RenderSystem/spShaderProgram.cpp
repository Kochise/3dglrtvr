...
Shader::Shader(ShaderTable* Table, const EShaderTypes Type, const EShaderVersions Version)
    : Type_(Type), Version_(Version), Table_(Table), HighLevel_(true), CompiledSuccessfully_(false)
{
