...
class SP_EXPORT SoundDevice
{
    ...
    public:
        ...
        //! Returns the interface name of the sound system (e.g. "WinMM" or "OpenSL|ES").
        virtual io::stringc getInterface() const;
        ...
        \param Mode: Type of sound object (not supported yet, implemented for futured sound systems such as DirectSound8 etc.).
        \return Pointer to the new Sound object.
        */
        virtual Sound* createSound(const ESoundModes Mode = SOUND_DYNAMIC) = 0;
        ...
        */
        virtual Sound* loadSound(
            const io::stringc &Filename, const ESoundModes Mode = SOUND_DYNAMIC, u8 BufferCount = DEF_SOUND_BUFFERCOUNT
        );
