...
ImageLoaderDDS::ImageLoaderDDS(const io::stringc &Filename)
    : ImageLoader(Filename), TexData_(0), ImageBufferSize_(0)
{
}
...
SImageData* ImageLoaderDDS::loadImageData()
{
