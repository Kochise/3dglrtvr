...
class SP_EXPORT ImageLoaderPCX : public ImageLoader
{
    ...
    public:
        ...
        ImageLoaderPCX(const io::stringc &Filename);
        ~ImageLoaderPCX();
    ...
    private:
        ...
        void readPCX1bit(SHeaderPCX* pHeader, SImageData* texture);
        void readPCX4bit(SHeaderPCX* pHeader, SImageData* texture);
        void readPCX8bit(SHeaderPCX* pHeader, SImageData* texture);
        void readPCX24bit(SHeaderPCX* pHeader, SImageData* texture);
