...
ImageLoaderTGA::ImageLoaderTGA(const io::stringc &Filename) : ImageLoader(Filename)
{
}
...
SImageData* ImageLoaderTGA::loadImageData()
{
...
bool ImageLoaderTGA::loadUncompressedTGA(SImageData* texture)
{
...
bool ImageLoaderTGA::loadCompressedTGA(SImageData* texture)
{
    texture->Format     = PIXELFORMAT_RGBA;     // Standard format
    texture->FormatSize = 4;                    // Standard internal format
