...
ImageLoaderPNG::ImageLoaderPNG(const io::stringc &Filename) : ImageLoader(Filename)
{
}
...
SImageData* ImageLoaderPNG::loadImageData()
{
...
void ImageLoaderPNG::getPNGInfo(s32 ColorType, SImageData* TextureInfo)
{
    switch (ColorType)
    {
