...
/*
 * ImageLoaderBMP class
 */

ImageLoaderBMP::ImageLoaderBMP(const io::stringc &Filename) : ImageLoader(Filename)
{
}
...
SImageData* ImageLoaderBMP::loadImageData()
{
    ...
    // Flip colors
    if (BottomUpImage)
        ImageConverter::flipImageColors(texture->ImageBuffer, texture->Width, texture->Height);
...
void ImageLoaderBMP::setImagePalettePixel(
    SImageData* Texture, const u32* Palette, const u32 ImageOffset, const u32 PaletteOffset)
{
