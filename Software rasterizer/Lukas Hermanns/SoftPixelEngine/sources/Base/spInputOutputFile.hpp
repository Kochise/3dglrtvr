...
enum EFileTypes
{
    FILE_HDD,   //!< File with read-/write access to Hard-Disk-Drive (HDD).
    FILE_RAM,   //!< Virtual file with read-/write access to RAM.
...
class SP_EXPORT File
{
    ...
    public:
        ...
        */
        ...
        For FileHDD objects this is a std::fstream* (C++ file stream),
        for FileRAM objects it is the char* to the buffer (or rather array),
