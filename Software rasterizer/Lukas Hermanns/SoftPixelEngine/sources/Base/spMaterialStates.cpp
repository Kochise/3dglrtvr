...
MaterialStates::MaterialStates()
    : UserMaterialProc_(0), RefRasterizerState_(0), RefDepthStencilState_(0), RefBlendState_(0)
{
    ColorDiffuse_       = color(255, 255, 255, 255);
    ColorAmbient_       = color(50, 50, 50, 255);
    ColorSpecular_      = color(255, 255, 255, 255);
    ColorEmission_      = color(0, 0, 0, 255);
    
    Shininess_          = 128.0f;
    AlphaReference_     = 0.0f;
    OffsetFactor_       = 0.0f;
    OffsetUnits_        = 0.0f;
