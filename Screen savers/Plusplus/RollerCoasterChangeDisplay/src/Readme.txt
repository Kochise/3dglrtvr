...
Installation
------------
For information about compiling see the "Install.txt" file.
...
License
-------
RollerCoaster2000 Screen Saver source code is distributed under the GNU
General Public License (see the "Copying.txt" file).
...
Jacob Navia: author of the free lcc-win32 C compiler. You can download it from
