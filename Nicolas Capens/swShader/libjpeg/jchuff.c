...
#define ASSIGN_STATE(dest,src)  	((dest).put_buffer = (src).put_buffer, 	 (dest).put_bits = (src).put_bits, 	 (dest).last_dc_val[0] = (src).last_dc_val[0], 	 (dest).last_dc_val[1] = (src).last_dc_val[1], 	 (dest).last_dc_val[2] = (src).last_dc_val[2], 	 (dest).last_dc_val[3] = (src).last_dc_val[3])
#endif
#endif
