...
The settings you can modify are the name of the file containing rollercoaster
description, or the directory where all the tracks lie, if you have choosen
the random track mode.
