...
void ColorScale::AddPoint(double v, double r, double g, double b, double a)
{
	if (c < n)
	{
		scale[c][0] = v;
...
void ColorScale::GetColor(double v, double& r, double& g, double& b, double& a)
{
	int i = 0;
	double w;
