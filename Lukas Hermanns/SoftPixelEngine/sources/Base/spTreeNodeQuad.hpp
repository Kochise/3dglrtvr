...
class SP_EXPORT QuadTreeNode : public TreeNode
{
    ...
    public:
        ...
        \param TreeNodeList: Resulting list with all found TreeNodeQuad objects.
        ...
        */
        ...
        //! \return Pointer the the specified TreeNodeQuad child object(index must be in a range of [0, 3]).
...
#if 1 // !!!
typedef QuadTreeNode TreeNodeQuad;
#endif
