...
{
    RESOURCE_HDD,   //!< Resource files will be read from HDD.
...
class SP_EXPORT FileSystem
{
    ...
    public:
        ...
        //! Opens a new FileHDD object with the specified filename and the specified permission.
        FileHDD* openFile(const stringc &Filename, const EFilePermission Permission = FILE_READWRITE);
        
        //! Opens a new FileRAM object with the specified permission.
        FileRAM* openFile(const EFilePermission Permission = FILE_READWRITE);
        
        //! Reads the whole specified file from HDD into the new FileRAM's buffer.
        FileRAM* readFile(const io::stringc &Filename);
        ...
        */
        ...
        //! Sets the resource cofiguration. By default RESOURCE_ASSET for Android and RESOURCE_HDD for other OS.
