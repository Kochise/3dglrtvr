...
DesktopRenderContext::DesktopRenderContext() :
    RenderContext(), Window_(0), DeviceContext_(0)
{
}
DesktopRenderContext::~DesktopRenderContext()
{
...
bool DesktopRenderContext::createWindow(const io::stringc &Title)
{
    ...
    if (!isFullscreen_)
    {
        __Screen_X = GetSystemMetrics(SM_CXFIXEDFRAME);
        __Screen_Y = GetSystemMetrics(SM_CYFIXEDFRAME) + GetSystemMetrics(SM_CYCAPTION);
    }
...
DesktopRenderContext::DesktopRenderContext() :
    RenderContext(), Display_(0), Screen_(0), Visual_(0)
{
}
DesktopRenderContext::~DesktopRenderContext()
{
