...
GLFramebufferObject::GLFramebufferObject()
    : FrameBufferID_(0), DepthBufferID_(0), MSFrameBufferID_(0)
{
}
GLFramebufferObject::~GLFramebufferObject()
{
...
void GLFramebufferObject::attachFramebufferTexture(
    GLuint TexID, GLenum GLDimension, const EPixelFormats Format, const ETextureDimensions DimensionType, const ECubeMapDirections CubeMapFace)
{
    /* Get texture target */
