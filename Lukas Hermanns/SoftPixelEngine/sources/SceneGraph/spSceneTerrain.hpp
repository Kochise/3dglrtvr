...
class SP_EXPORT Terrain : public MaterialNode
{
    ...
    protected:
        ...
        void createQuadTree(TreeNodeQuad* Node, s32 &MIPLevel, dim::point2di CurPos);
        void createTreeNodeMesh(TreeNodeQuad* Node, STreeNodeData* NodeData, const dim::point2di &CurPos);
        void selectTreeNodeMesh(TreeNodeQuad* Node);
        void renderTreeNodeMesh(TreeNodeQuad* Node);
        bool deformTreeNodeMesh(TreeNodeQuad* Node, const dim::point2df &Pos);
        
        s32 getNodeLevel(const TreeNodeQuad* Node, const dim::point2df &Pos);
        ...
        TreeNodeQuad* RootTreeNode_;
        video::MeshBuffer* MeshTexReference_;
        
        s32 RenderModeListSize_;
        std::vector<TreeNodeQuad*> RenderNodeList_;
