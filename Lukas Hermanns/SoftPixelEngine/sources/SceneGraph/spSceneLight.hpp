...
class SP_EXPORT Light : public SceneNode
{
    ...
    protected:
        ...
        // default spot-light-cone-angle (inner and outer)
        static const f32 DEF_SLCA_INNER;
        static const f32 DEF_SLCA_OUTER;
        
        /* === Members ===*/
        
        // Identity information
        u32 LightID_;
        ELightModels LightingType_;
        
        // Spot information
        dim::vector3df Direction_;
        f32 SpotInnerConeAngle_, SpotOuterConeAngle_;
        
        // Volumetrical information
        bool isVolumetric_;
