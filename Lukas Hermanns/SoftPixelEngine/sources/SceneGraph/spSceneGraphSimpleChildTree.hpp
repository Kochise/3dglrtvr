/*
 * Simple child tree scene graph header
 * 
 * This file is part of the "SoftPixel Engine" (Copyright (c) 2008 by Lukas Hermanns)
 * See "SoftPixelEngine.hpp" for license information.
 */

#ifndef __SP_SCENEGRAPH_SIMPLE_CHILDTREE_H__
#define __SP_SCENEGRAPH_SIMPLE_CHILDTREE_H__
...
/**
The SceneManagerSimpleChildTree is used for simple scenes with a child tree hierarchy. Each root object will be passed through
...
*/
class SP_EXPORT SceneGraphSimpleChildTree : public SceneGraph
{
    
    public:
        
        SceneGraphSimpleChildTree();
        virtual ~SceneGraphSimpleChildTree();
