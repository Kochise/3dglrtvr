...
class SP_EXPORT MeshLoaderB3D : public MeshLoader
{
    ...
    private:
        ...
        struct SSkeletonBoneB3D
        {
            ...
            SSkeletonBoneB3D()
                : VerticesList(0), WeightsCount(0), KeyframeList(0), KeyframeCount(0)
            {
                TabSize         = 0;
                ParentBoneID    = 0;
                Scale           = 1.0f;
            ...
            ~SSkeletonBoneB3D()
            {
                ...
                MemoryManager::deleteBuffer(KeyframeList);
            }
            ...
            {
                SBoneKeyframeInfo() : isUndefined(true), Scale(1.0f)
                {
                }
                ~SBoneKeyframeInfo()
                {
                ...
                bool isUndefined;           //!< If true, this keyframe will be copied from the previous defined keyframe
            ...
            SBoneKeyframeInfo* KeyframeList;
            s32 KeyframeCount;
        };
