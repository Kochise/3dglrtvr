...
void GUIManager::update()
{
    ...
    Time_           = __spDevice->getMilliseconds();
...
void GUIManager::init()
{
    ...
    TexInterface_ = __spVideoDriver->createTexture(
        dim::size2di(__Screen_Width, __Screen_Height), video::PIXELFORMAT_RGBA
    );
...
void GUIManager::createHatchedFace()
{
    ...
    u8* ImageBuffer = new u8[2*2*4];
    
    *((s32*)ImageBuffer + 0) = 0x90000000;
    *((s32*)ImageBuffer + 1) = 0x00000000;
    *((s32*)ImageBuffer + 2) = 0x00000000;
    *((s32*)ImageBuffer + 3) = 0x90000000;
    
    HatchedFace_->updateImageBuffer(ImageBuffer);
...
void GUIManager::createArrowTex()
{
    ...
    ArrowTex_->updateImageBuffer(ImageBuffer);
