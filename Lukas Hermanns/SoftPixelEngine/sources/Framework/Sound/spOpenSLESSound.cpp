...
#include "Framework/Sound/spOpenSLESSound.hpp"
...
OpenSLESSound::OpenSLESSound(const ESoundModes Mode)
    : Sound(Mode), AudioPlayer_(0), AudioPlay_(0), AudioSeek_(0), AudioVolume_(0)
{
}
