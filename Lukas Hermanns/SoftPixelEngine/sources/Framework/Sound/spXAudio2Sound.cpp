...
#include "Framework/Sound/spXAudio2Sound.hpp"
...
XAudio2Sound::XAudio2Sound(const ESoundModes Mode) :
    Sound(Mode), SoruceVoice_(0), WaveBuffer_(0)
{
}
...
void XAudio2Sound::play(bool Looped)
{
    Sound::play(Looped);
